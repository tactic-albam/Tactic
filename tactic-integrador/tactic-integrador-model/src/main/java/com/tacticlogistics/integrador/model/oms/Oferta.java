...
@Entity
@Table(catalog = "oms", name = "ofertas")
@NoArgsConstructor
@Data
...
public class Oferta extends Registro {
	...
	@Builder
	public Oferta(Long id, String clienteCodigo, String servicioCodigo, String numeroOrden, LocalDate femi,
			LocalDate fema, String productoCodigo, String productoNombre, int cantidad, String bodegaCodigo,
			String estadoInventarioCodigo, Long idCliente, Long idServicio, Long idProducto,
