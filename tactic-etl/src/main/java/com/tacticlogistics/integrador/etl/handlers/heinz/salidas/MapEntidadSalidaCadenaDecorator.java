package com.tacticlogistics.integrador.etl.handlers.heinz.salidas;
...
public class MapEntidadSalidaCadenaDecorator extends MapEntidadDecorator<SalidaCadena> {

	public MapEntidadSalidaCadenaDecorator() {
		super();
	}

	public MapEntidadSalidaCadenaDecorator(Filter<SalidaCadena> inner) {
		super(inner);
	}
